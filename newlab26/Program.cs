...
namespace newlab26
{
    public class Program
    {
        ...
        {
            Console.WriteLine("Лабораторная работа №6. Выполнил студент 6103-020302D группы Сидоров Артемий");
            while (true)
            {
                ...
                SelectionMenu selectionMenu = null;

                switch (selectedAction)
                {
                    case "1":
                        selectionMenu += TestBinVectors;
                        break;
                    case "2":
                        selectionMenu += TestFileVectors;
                        break;
                    case "3":
                        selectionMenu += TestSerialization;
                        break;
                    case "4":
                        selectionMenu += Run4LabMenu;
                        break;
                    case "5":
                        return;
                    default:
                        selectionMenu += EmptyAnswer;
                        break;
                }
        ...
        private static void TestBinVectors()
        {
        ...
        private static void TestFileVectors()
        {
        ...
        private static void EmptyAnswer()
        {
