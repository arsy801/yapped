namespace newlab22
{
    class Program
    {
        public static void Main()
        {
            ...
            while (alive == true)
            {
                Console.WriteLine("\nСеместр 2, Лабораторная работа 2, выполнил студент Артемий Сидоров\n");
                    ...
                    case "1":
                        {
                            ...
                            ArrayVector2 vector = new ArrayVector2(temp.Length);
                    ...
                    case "3":
                        {
                            ...
                            ArrayVector2 vector1 = new ArrayVector2(temp1.Length);
                            ...
                            ArrayVector2 vector2 = new ArrayVector2(temp2.Length);
                            ...
                            try
                            {
                                ArrayVector2 sum = Vectors.Sum(vector1, vector2);
